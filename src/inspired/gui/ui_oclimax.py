...
class Ui_OCLIMAX(object):
    ...
    def retranslateUi(self, OCLIMAX):
        ...
        self.label_29.setToolTip(
            _translate(
                "OCLIMAX",
                "Increase Q point density when dispersion appears disconnected",
            )
        )
        ...
        self.groupBox_2.setTitle(
            _translate(
                "OCLIMAX",
                "OCLIMAX parameters                                                                                                                  Single crystal parameters",
            )
        )
        ...
        self.label_6.setToolTip(
            _translate(
                "OCLIMAX",
                "Energy resolution coefficients r0 r1 r2 ... with FWHM=2.355*(r0+r1*E+r2*E^2+...). Use -1 for no resolution.",
            )
        )
        ...
        self.label_2.setToolTip(
            _translate(
                "OCLIMAX",
                'Choose a type of calculation. Click "Help" at bottom right for more information.',
            )
        )
        ...
        self.label_19.setToolTip(
            _translate(
                "OCLIMAX",
                "Set 1 to simulate [Q,E] envelope due to kinematics and detector coverage",
            )
        )
        ...
        self.label_7.setToolTip(
            _translate(
                "OCLIMAX",
                "Q resolution coefficients r0 r1 r2 ... with FWHM=2.355*(r0+r1*Q+r2*Q^2+...). Use -1 for no resolution.",
            )
        )
        ...
        self.label_3.setToolTip(
            _translate(
                "OCLIMAX",
                "Energy cutoff (phonon modes below this cutoff will be ignored)",
            )
        )
        ...
        self.label_20.setToolTip(
            _translate(
                "OCLIMAX",
                "Normalize spectral intensity with total scattering cross-section",
            )
        )
        ...
        self.pushButton_oclimax_default.setToolTip(
            _translate("OCLIMAX", "Default calculation for 1D VISION/TOSCA spectra")
        )
        self.pushButton_oclimax_default.setText(_translate("OCLIMAX", "Reset to default"))
        self.pushButton_oclimax_save.setToolTip(
            _translate(
                "OCLIMAX",
                "Save parameters to a params file before running the calculation",
            )
        )
