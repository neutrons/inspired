...
class Ui_OCLIMAX(object):
    def setupUi(self, OCLIMAX):
        ...
        self.comboBox_xaxis.addItem("")
        self.comboBox_xaxis.addItem("")
        self.gridLayout_2.addWidget(self.comboBox_xaxis, 8, 1, 1, 1)
        self.lineEdit_Ebin = QtWidgets.QLineEdit(self.groupBox_2)
        self.lineEdit_Ebin.setObjectName("lineEdit_Ebin")
        self.gridLayout_2.addWidget(self.lineEdit_Ebin, 7, 1, 1, 1)
        ...
        self.comboBox_yaxis.addItem("")
        self.comboBox_yaxis.addItem("")
        self.gridLayout_2.addWidget(self.comboBox_yaxis, 9, 1, 1, 1)
        ...
        self.lineEdit_HKL = QtWidgets.QLineEdit(self.groupBox_2)
        self.lineEdit_HKL.setObjectName("lineEdit_HKL")
        self.gridLayout_2.addWidget(self.lineEdit_HKL, 6, 1, 1, 1)
    ...
    def retranslateUi(self, OCLIMAX):
        ...
        self.label_6.setToolTip(_translate("OCLIMAX", "Energy resolution coefficients r0 r1 r2 ... with FWHM=2.355*(r0+r1*E+r2*E^2+...). Use -1 for no resolution."))
        self.label_6.setText(_translate("OCLIMAX", "E Res"))
        ...
        self.label_2.setToolTip(_translate("OCLIMAX", "Choose a type of calculation. Click \"Help\" at bottom right for more information."))
        ...
        self.label_21.setText(_translate("OCLIMAX", "Angle"))
        ...
        self.label_7.setToolTip(_translate("OCLIMAX", "Q resolution coefficients r0 r1 r2 ... with FWHM=2.355*(r0+r1*Q+r2*Q^2+...). Use -1 for no resolution."))
        self.label_7.setText(_translate("OCLIMAX", "Q Res"))
        ...
        self.pushButton_oclimax_load.setText(_translate("OCLIMAX", "Load from file"))
        self.pushButton_oclimax_default.setToolTip(_translate("OCLIMAX", "Default calculation for 1D VISION/TOSCA spectra"))
        self.pushButton_oclimax_default.setText(_translate("OCLIMAX", "Reset to default"))
        ...
        self.pushButton_oclimax_save.setText(_translate("OCLIMAX", "Save and use current parameters"))
        ...
        self.label_30.setToolTip(_translate("OCLIMAX", "HKL for the center of the BZ of interest (must be integers)"))
        self.label_30.setText(_translate("OCLIMAX", "Zone Center"))
